            ...
            <div class="content-data">
                ...
                <form method="GET" action="{{ route('laporan.sanksi.belum_bayar') }}" class="filter-form-grid">
                    ...
                    <div class="filter-buttons-container">
                        ...
                        <a href="{{ route('laporan.sanksi.belum_bayar') }}" class="btn-download btn-reset">
            ...
            <div class="content-data">
                ...
                @else
                    <div class="empty-state">
                        ...
                        <h3>Tidak ada data sanksi belum bayar</h3>
                        <p>Belum ada sanksi yang belum dibayar dalam sistem.</p>
                    </div>
                @endif
            </div>
        </div>
...
@section('scripts')
    ...
    <script>
        ...
        function exportToPDF() {
            ...
            // Add title
            doc.setFontSize(16);
            doc.text('Laporan Sanksi Belum Bayar', 20, 20);
            ...
            // Save the PDF
            doc.save('laporan-sanksi-belum-bayar.pdf');
        }
        ...
        function exportToExcel() {
            ...
            const workbook = XLSX.utils.table_to_book(table, {
                sheet: 'Sanksi Belum Bayar'
            });
            XLSX.writeFile(workbook, 'laporan-sanksi-belum-bayar.xlsx');
        }
        ...
        function printTable() {
            ...
            printWindow.document.write(`
                <html>
                <head>
                    <title>Laporan Sanksi Belum Bayar</title>
                    <style>
                ...
                <body>
                    <h1>Laporan Sanksi Belum Bayar</h1>
