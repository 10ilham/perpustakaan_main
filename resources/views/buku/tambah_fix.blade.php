...
@section('scripts')
    <!-- Library Cleave.js dari CDN untuk format mata uang Rupiah -->
    <script src="https://cdn.jsdelivr.net/npm/cleave.js@1.6.0/dist/cleave.min.js"></script>

    <script>
        // Tunggu halaman selesai dimuat
        document.addEventListener('DOMContentLoaded', function() {
            // Inisialisasi format Rupiah untuk input harga buku
            var formatHargaBuku = new Cleave('#harga_buku', {
                numeral: true, // Menggunakan format angka
                numeralDecimalMark: ',', // Tanda desimal menggunakan koma
                delimiter: '.', // Pemisah ribuan menggunakan titik
                numeralPositiveOnly: true, // Hanya angka positif
                prefix: 'Rp ', // Awalan Rp dan spasi
                numeralIntegerScale: 12, // Maksimal 12 digit angka (milyaran)
                stripLeadingZeroes: false // Tidak hilangkan nol di depan
            });
